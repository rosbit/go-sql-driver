...
func (d *TDriver) Exec(conn interface{}, sql string, args ...interface{}) (ExecResult, error) {
	fmt.Printf("exec: %s called\n", sql)
	return &TResult{}, nil
}

func (d *TDriver) Query(conn interface{}, sql string, args ...interface{}) (ResultSet, error) {
